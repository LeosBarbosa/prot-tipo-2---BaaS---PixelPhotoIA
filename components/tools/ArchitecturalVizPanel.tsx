            ...
            <aside className="w-full md:w-96 flex-shrink-0 bg-gray-900/30 rounded-lg p-4 flex flex-col gap-4 border border-gray-700/50">
                <h2 className="text-xl font-bold text-white text-center">Controles</h2>
                 <div className="flex flex-col gap-4">
                    ...
                    <textarea value={prompt} onChange={e => setPrompt(e.target.value)} placeholder="Ex: adicione uma janela grande..." className="w-full bg-gray-800 border border-gray-600 rounded-lg p-3 text-base min-h-[100px]" disabled={isLoading}/>
