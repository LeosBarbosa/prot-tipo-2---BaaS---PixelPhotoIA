...
const filters = [
    ...
    { name: 'Vintage', prompt: 'aplique um efeito de foto antiga, com grão de filme, leve dessaturação de cores e um leve tom sépia', bg: 'bg-gradient-to-br from-amber-600 to-stone-700' },
