...
const trends: Trend[] = [
    ...
    { name: 'Glitch', prompt: 'aplique um efeito de glitch digital, com distorção de pixels, aberração cromática e linhas de varredura', bg: 'bg-gradient-to-br from-red-500 to-blue-500', icon: 'BoltIcon' },
    { name: 'Duotone', prompt: 'converta a imagem para um efeito duotone, usando as cores primárias de azul vibrante e rosa choque', bg: 'bg-gradient-to-br from-blue-500 to-pink-500', icon: 'SparkleIcon' },
    { name: 'Risograph', prompt: 'simule uma impressão risograph, com cores limitadas (vermelho e azul), grão e sobreimpressão sutil', bg: 'bg-gradient-to-br from-red-400 to-sky-400', icon: 'TextureIcon' },
    { 
        name: 'Holográfico', 
    ...
    { name: 'Caixa de Boneco', prompt: 'Coloque a pessoa principal da foto dentro de uma caixa de boneca de brinquedo colecionável. A caixa deve ter um design temático, uma janela de plástico transparente e texto como "Edição Limitada". O resultado deve ser fotorrealista e divertido.', bg: 'bg-gradient-to-br from-pink-500 to-violet-500', icon: 'ToyIcon' },
    { name: 'Preto e Branco', prompt: 'Crie um retrato em primeiro plano, com alto contraste, em preto e branco com lentes 35mm e qualidade 4K HD. Adicione um leve efeito de gotas de água no rosto para um toque dramático.', bg: 'bg-gradient-to-br from-gray-400 to-gray-800', icon: 'CameraIcon' },
    {
        name: 'Estilo Pixar',
    ...
    {
        name: "Esboço Carvão (Masc.)",
        prompt: "Edit this image to transform it into an expressionist charcoal sketch of a handsome man with intense, deep-set eyes that hold a sense of wisdom and mystery. Create the artwork with bold, passionate, and soulful charcoal strokes. He's captured in a dynamic pose—head turned slightly, chin subtly lifted, eyes gazing directly at the viewer with a penetrating intensity. His features are strong and defined—a sharp jawline, defined cheekbones, and a rugged brow, rendered with confident yet tender charcoal lines. Areas of intense darkness should contrast against luminous, barely-touched paper that creates highlights. He wears a dark, draped fabric over one shoulder, suggested through sweeping, gestural strokes. The lighting is moody and cinematic: a strong key light from the side carves out his features, while deep shadows add to the mystery. The background is alive with emotional energy—explosive charcoal marks suggesting turmoil or passion. Include visible texture: paper grain showing through, smudged areas, and strategic erasing that creates ethereal highlights. The overall atmosphere is one of haunting strength and introspection.",
    ...
    {
        name: "Arte Cinematográfica Anos 80/90",
        prompt: "Transforme a imagem fornecida em uma ilustração cinematográfica pintada à mão, no estilo dos pôsteres clássicos dos anos 80 e início dos 90. O resultado deve ter aparência de pintura realista feita com tinta acrílica ou óleo, com texturas de pincel, luzes dramáticas, tons quentes e contrastantes, e composição épica e detalhada. Características desejadas: Estilo de arte inspirado em artistas como Drew Struzan e Richard Amsel. Cores vibrantes, iluminação de destaque e sombras cinematográficas. Expressão confiante, pose de protagonista de cinema. Fundo com elementos narrativos: relíquias antigas, carros esportivos, cidades noturnas, magia, céu estrelado ou efeitos de luz — conforme o tema. Tipografia artística pode ser sugerida, mas sem texto legível. O resultado deve parecer um pôster de filme de aventura, fantasia ou comédia dos anos 80, como 'Raiders of the Lost Ark' ou 'Back to the Future'. Estilo geral: Pintura realista + composição heroica + atmosfera nostálgica de cinema vintage.",
        bg: 'bg-gradient-to-br from-amber-500 to-indigo-700',
        icon: 'CameraIcon',
    },
    {
        name: "Retrato de Belas Artes",
        prompt: "Transforme a foto em uma pintura a óleo de belas artes, altamente detalhada e realista, no estilo clássico. Preserve 100% das características faciais originais. Use pinceladas suaves e um alto nível de detalhe no rosto. Aplique uma gradação de cor cinematográfica e iluminação brilhante para destacar o rosto. O fundo deve ser uma pintura abstrata em tela com cores complementares. A iluminação deve ser dramática, destacando as bordas da pessoa para separá-la do fundo, integrando-a perfeitamente à cena. O resultado deve ter a sensação de alta qualidade de uma pintura tradicional.",
        bg: 'bg-gradient-to-br from-amber-600 to-rose-800',
        icon: 'BrushIcon',
    },
    {
        name: 'Dissolução Quântica',
        prompt: 'Transforme a imagem em um retrato surreal ultra-realista da pessoa se dissolvendo em feixes luminosos de energia e código digital. Perfil lateral elegante, com luz roxa e ciano brilhante fluindo do corpo, partículas de dados etéreas ao redor. Iluminação cinematográfica com brilho volumétrico e fundo bokeh suave. Mantenha a textura da pele detalhada e uma expressão emocional. O ambiente deve ser minimalista e futurista, com integração de linhas holográficas e código binário, e uma névoa de luz ao redor da silhueta, criando uma aura de luz quântica. O resultado deve ter um tom poético e elegante, renderizado em 8K UHD.',
        bg: 'bg-gradient-to-br from-purple-500 to-cyan-400',
        icon: 'SparkleIcon'
    },
    {
        name: "Herói do Oceano",
        prompt: "Crie uma foto e certifique-se de que o rosto corresponda exatamente ao rosto do modelo na foto que forneci. Modelo masculino de 29 anos, físico em forma, atlético e musculoso, em pé, sem camisa, da cintura para cima, nas ondas quebrando na beira do mar, adornado com colares de conchas e pérolas em camadas, delicados pingentes de búzios brancos e corais, pulseiras trançadas e cordões de couro enrolados nos pulsos, uma saia pareô iridescente verde-azulada molhada e colada ao corpo, gotas de água no ar e aderindo à pele molhada e brilhante, horizonte do pôr do sol atrás com céu quente laranja e rosa encontrando o oceano azul profundo, cena de fotografia de moda hiper-realista, câmera full frame Sony a7R IV com lente Sony FE 85mm f/1.4 GM, distância focal 85mm, abertura f/2.8 para criar uma profundidade de campo rasa com objeto nítido e bokeh cremoso, ISO 200 para baixo ruído, velocidade do obturador 1/1000 s para congelar salpicos de água, sincronização de flash em burst 1/1250 s possível para capturar luz adicional, câmera posicionada a 2,5 metros do objeto, ângulo ligeiramente baixo em aproximadamente 10 graus para cima para enfatizar o torso e a mandíbula, composição centrada em três quartos com o objeto ocupando o eixo vertical central e os olhos na interseção aproximada da regra dos terços do terço superior, luz de fundo suave da hora dourada do pôr do sol criando uma luz de borda quente nos ombros e cabelos molhados, preenchimento difuso de um refletor prateado macio de 5 pontos à esquerda da câmera para revelar detalhes do torso, flashes sutis fora da câmera em baixa potência para realces especulares nas pérolas, vento oceânico ambiente natural esvoaçando cabelo e tecido molhados, paleta de cores de realces quentes coral-laranja contrastando com sombras frias verde-azuladas e azul marinho profundo, captura de alto alcance dinâmico para preservar detalhes de realce na água e detalhes de sombra na saia, texturas enfatizadas: pele molhada e lisa com poros visíveis e gotas finas, couro trançado fosco, conchas de madrepérola lustrosas, pérolas macias e redondas, tecido semi-translúcido semelhante a seda com brilho sutil, afloramentos rochosos salpicados pelo mar ligeiramente visíveis ao fundo, clima cinematográfico e mítico, heroico mas sereno, vibe de moda editorial cinematográfica, resolução ultra-detalhada 8K, alta nitidez e micro contraste, grão de filme suave de 8% para textura orgânica, clareza seletiva e dodge & burn para esculpir músculos, vinheta sutil para chamar a atenção para o torso, gradação de cores com realces quentes e sombras frias, leve tonalidade azul-verde dividida em sombras, tons de pele naturais preservados, correção de lente e remoção de aberração cromática, nitidez moderada em 50 raio 0.8, redução de ruído preservando detalhes finos, resultado final adequado para capas de revistas de alta qualidade e impressão de grande formato.",
        bg: 'bg-gradient-to-br from-orange-400 to-blue-600',
        icon: 'CameraIcon',
        type: 'descriptive',
    },
];
    ...
    return (
        <div className="w-full flex flex-col gap-4 animate-fade-in">
            ...
            <div className={`transition-opacity duration-300 ${isPreviewLoading || previewState ? 'opacity-50 pointer-events-none' : 'opacity-100'}`}>
                ...
                <TipBox>
                    Clique em um dos estilos abaixo para gerar uma pré-visualização. Depois, use o botão "Aplicar Estilo" que aparecerá acima para confirmar a alteração.
                </TipBox>
                    ...
                    {trends.map(trend => (
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col items-center justify-center gap-2">
                                <LazyIcon name={trend.icon} className="w-8 h-8 text-white/90 drop-shadow-lg" />
